...
public class BuscarParkingActivity extends AppCompatActivity implements IDataReceiver {
    ...
    protected void createBaseData() {
        ...
        for(int i=0; i<listaPlantas.getPlantas().size();i++){
            ...
            if (numElementsActualizados == 0) {
                Uri insertUri = contentResolver.insert(ModelContracts.FloorModel.buildContentUri(), contentValues);
            }
