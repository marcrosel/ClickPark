...
public class EscogerVehiculoCatActivity extends AppCompatActivity {
    ...
    public final static  String plantaIDCat = "FloorIdCat";
    public final static String typeSlot = "TypeSlot";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.plazas_disp_cat);
        ...
        final String floorId = intent.getStringExtra(PlantasCatActivity.PlantasCat);
                ...
                if (c != null) {
                    ...
                    if (nPlazas==0){
                        ...
                        comunImage.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent intent = new Intent(getApplicationContext(), PlazaAsignadaCatActivity.class);
                                intent.putExtra(plantaIDCat,floorId);
